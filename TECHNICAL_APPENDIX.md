...
$$
\widehat r=\underbrace{\sum_k w_k\widehat p_k c_k}_{\text{per-achievement term}}+\underbrace{\widehat p_{\mathrm{any}}\frac{\sum_k(1-w_k)c_k\mathbf 1[\text{locked}_k]}{\text{number locked}}}_{\text{pooled rare-event term}}+0.1\widehat{\Delta\mathrm{health}}.
$$
